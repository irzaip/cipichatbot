...
fileyaml = 'tokopedia.yml'
fileinput = 'input.txt'
filestopword = 'stopword-id.txt'

rel_dir = '/data/tokopedia/'
...
def process():
    global entdic
    barang=entdic['entity'][0]['value']
    print("memprosess Tokopedia:", barang)

    try:
        import webbrowser
        url = 'https://www.tokopedia.com/search?st=product&q='+str(barang)
        webbrowser.open(url)
    except:
        pass
