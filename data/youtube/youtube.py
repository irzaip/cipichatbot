...
fileyaml = 'youtube.yml'
fileinput = 'input.txt'
filestopword = 'stopword-id.txt'

rel_dir = '/data/youtube/'
...
def process():
    global entdic
    film=entdic['entity'][0]['value']
    print("memprosess YouTube:", film)

    try:
        import webbrowser
        url = 'https://www.youtube.com/results?search_query='+str(film)
        webbrowser.open(url)
    except:
        pass
